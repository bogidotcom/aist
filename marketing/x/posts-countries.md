# AIST — X campaign, country rollout
...
## et-1 · aiETB listed on P2P

**English** — `img/c/et-en/1.png`

```
aiETB is now trading on the AIST P2P book.
...
```
aiETB አሁን በ AIST P2P መዝገብ ላይ እየተገበያየ ነው።
...
**English** — `img/c/et-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiETB — all on one book.
...
```
BTC፣ በአምስት አውታረ መረቦች USDT፣ KGST፣ ETH፣ SOL እና aiETB — ሁሉም በአንድ መዝገብ ላይ።
...
## et-3 · Simple spread arbitrage

**English** — `img/c/et-en/3.png`
...
```
ተመሳሳይ ጥንድ፣ ተመሳሳይ ደቂቃ፣ እና በዋጋ ያልተስማሙ ሁለት ሰሪዎች።
...
## et-4 · What is P2P (edu)

**English** — `img/c/et-en/4.png`

```
You are not trading against an exchange. You are trading against another person.
...
```
ከምንዛሪ ቤት ጋር አይደለም የምትገበያዩት። ከሌላ ሰው ጋር ነው።
...
## et-5 · Referral programme

**English** — `img/c/et-en/5.png`

```
Share your link. They trade on the book. You earn on it.
...
```
አገናኛችሁን አጋሩ። እነሱ በመዝገቡ ላይ ይገበያያሉ። እናንተ በዚያ ላይ ታገኛላችሁ።
...
## et-6 · Growing AI community

**English** — `img/c/et-en/6.png`

```
Every GPU in Ethiopia that takes an AI job gets paid in aiETB.
...
```
በኢትዮጵያ ውስጥ የAI ሥራ የሚይዝ እያንዳንዱ GPU በaiETB ይከፈለዋል።
...
## et-7 · Why P2P — no middleman

**English** — `img/c/et-en/7.png`

```
P2P means you and the maker, directly.
...
```
P2P ማለት እናንተ እና ሰሪው፣ በቀጥታ ማለት ነው።
...
## et-8 · Payment-method arbitrage

**English** — `img/c/et-en/8.png`

```
The same USDT is worth different ETB depending on how the money moves.
...
```
ተመሳሳዩ USDT ገንዘቡ በሚንቀሳቀስበት መንገድ መሠረት የተለያየ ETB ያወጣል።
...
## bt-1 · aiBTN listed on P2P

**English** — `img/c/bt-en/1.png`

```
aiBTN is now trading on the AIST P2P book.
...
**English** — `img/c/bt-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiBTN — all on one book.
...
## bt-3 · Simple spread arbitrage

**English** — `img/c/bt-en/3.png`
...
## bt-4 · What is P2P (edu)

**English** — `img/c/bt-en/4.png`
...
## bt-5 · Referral programme

**English** — `img/c/bt-en/5.png`
...
## bt-6 · Growing AI community

**English** — `img/c/bt-en/6.png`

```
Every GPU in Bhutan that takes an AI job gets paid in aiBTN.
...
## bt-7 · Why P2P — no middleman

**English** — `img/c/bt-en/7.png`
...
## bt-8 · Payment-method arbitrage

**English** — `img/c/bt-en/8.png`

```
The same USDT is worth different BTN depending on how the money moves.
...
## kg-1 · aiKGS listed on P2P

**English** — `img/c/kg-en/1.png`

```
KGST is now trading on the AIST P2P book.
...
```
KGST эми AIST P2P стаканында сатылат.
...
**English** — `img/c/kg-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and KGST — all on one book.
...
```
BTC, беш тармактагы USDT, KGST, ETH, SOL жана KGST — баары бир стаканда.
...
## kg-3 · Simple spread arbitrage

**English** — `img/c/kg-en/3.png`
...
```
Бир жуп, бир мүнөт жана баада келишпеген эки мейкер.
...
## kg-4 · What is P2P (edu)

**English** — `img/c/kg-en/4.png`
...
```
Сиз биржага каршы соода кылбайсыз. Сиз башка адам менен соода кыласыз.
...
## kg-5 · Referral programme

**English** — `img/c/kg-en/5.png`
...
```
Шилтемеңизди бөлүшүңүз. Алар стаканда соода кылат. Сиз андан киреше аласыз.
...
## kg-6 · Growing AI community

**English** — `img/c/kg-en/6.png`

```
Every GPU in Kyrgyzstan that takes an AI job gets paid in KGST.
...
```
Кыргызстандагы AI тапшырма алган ар бир GPU KGST менен төлөм алат.
...
## kg-7 · Why P2P — no middleman

**English** — `img/c/kg-en/7.png`
...
## kg-8 · Payment-method arbitrage

**English** — `img/c/kg-en/8.png`

```
The same USDT is worth different KGS depending on how the money moves.
...
```
Бир эле USDT акчанын кандай жылганына жараша ар башка KGS турат.
...
## ve-1 · aiVES listed on P2P

**English** — `img/c/ve-en/1.png`

```
aiVES is now trading on the AIST P2P book.
...
```
aiVES ya se opera en el libro P2P de AIST.
...
**English** — `img/c/ve-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiVES — all on one book.
...
```
BTC, USDT en cinco redes, KGST, ETH, SOL y aiVES — todo en un solo libro.
...
## ve-3 · Simple spread arbitrage

**English** — `img/c/ve-en/3.png`
...
## ve-4 · What is P2P (edu)

**English** — `img/c/ve-en/4.png`
...
```
No operas contra un exchange. Operas contra otra persona.
...
## ve-5 · Referral programme

**English** — `img/c/ve-en/5.png`
...
```
Comparte tu enlace. Ellos operan en el libro. Tú ganas con eso.
...
## ve-6 · Growing AI community

**English** — `img/c/ve-en/6.png`

```
Every GPU in Venezuela that takes an AI job gets paid in aiVES.
...
```
Cada GPU en Venezuela que toma un trabajo de IA cobra en aiVES.
...
## ve-7 · Why P2P — no middleman

**English** — `img/c/ve-en/7.png`
...
```
P2P significa tú y el maker, directo.
...
## ve-8 · Payment-method arbitrage

**English** — `img/c/ve-en/8.png`

```
The same USDT is worth different VES depending on how the money moves.
...
```
El mismo USDT vale distintos VES según cómo se mueva el dinero.
...
## py-1 · aiPYG listed on P2P

**English** — `img/c/py-en/1.png`

```
aiPYG is now trading on the AIST P2P book.
...
```
aiPYG ya se opera en el libro P2P de AIST.
...
**English** — `img/c/py-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiPYG — all on one book.
...
```
BTC, USDT en cinco redes, KGST, ETH, SOL y aiPYG — todo en un solo libro.
...
## py-3 · Simple spread arbitrage

**English** — `img/c/py-en/3.png`
...
## py-4 · What is P2P (edu)

**English** — `img/c/py-en/4.png`
...
## py-5 · Referral programme

**English** — `img/c/py-en/5.png`
...
## py-6 · Growing AI community

**English** — `img/c/py-en/6.png`

```
Every GPU in Paraguay that takes an AI job gets paid in aiPYG.
...
```
Cada GPU en Paraguay que toma un trabajo de IA cobra en aiPYG.
...
## py-7 · Why P2P — no middleman

**English** — `img/c/py-en/7.png`
...
## py-8 · Payment-method arbitrage

**English** — `img/c/py-en/8.png`

```
The same USDT is worth different PYG depending on how the money moves.
...
```
El mismo USDT vale distintos PYG según cómo se mueva el dinero.
...
# Bangladesh · aiBDT · BDT


## bd-1 · aiBDT listed on P2P

**English** — `img/c/bd-en/1.png`

```
aiBDT is now trading on the AIST P2P book.
...
```
aiBDT এখন AIST P2P বুকে ট্রেড হচ্ছে।
...
**English** — `img/c/bd-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiBDT — all on one book.
...
```
BTC, পাঁচ নেটওয়ার্কে USDT, KGST, ETH, SOL আর aiBDT — সব এক বুকে।
...
## bd-3 · Simple spread arbitrage

**English** — `img/c/bd-en/3.png`
...
```
একই পেয়ার, একই মিনিট, আর দুই মেকার যারা দামে একমত নয়।
...
## bd-4 · What is P2P (edu)

**English** — `img/c/bd-en/4.png`
...
```
আপনি কোনো এক্সচেঞ্জের বিরুদ্ধে ট্রেড করছেন না। আপনি আরেকজন মানুষের সাথে ট্রেড করছেন।
...
## bd-5 · Referral programme

**English** — `img/c/bd-en/5.png`
...
```
আপনার লিংক শেয়ার করুন। তারা বুকে ট্রেড করে। আপনি তাতে আয় করেন।
...
## bd-6 · Growing AI community

**English** — `img/c/bd-en/6.png`

```
Every GPU in Bangladesh that takes an AI job gets paid in aiBDT.
...
```
বাংলাদেশ-র যে GPU এআই কাজ নেয়, সে aiBDT-এ পেমেন্ট পায়।
...
## bd-7 · Why P2P — no middleman

**English** — `img/c/bd-en/7.png`
...
## bd-8 · Payment-method arbitrage

**English** — `img/c/bd-en/8.png`

```
The same USDT is worth different BDT depending on how the money moves.
...
```
একই USDT-র দাম ভিন্ন BDT হয়, টাকা কীভাবে নড়ে তার উপর।
...
## pk-1 · aiPKR listed on P2P

**English** — `img/c/pk-en/1.png`

```
aiPKR is now trading on the AIST P2P book.
...
```
‏aiPKR اب AIST P2P بُک پر ٹریڈ ہو رہا ہے۔
...
**English** — `img/c/pk-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiPKR — all on one book.
...
```
‏BTC، پانچ نیٹ ورکس پر USDT، KGST، ETH، SOL اور aiPKR — سب ایک ہی بُک پر۔
...
## pk-3 · Simple spread arbitrage

**English** — `img/c/pk-en/3.png`
...
## pk-4 · What is P2P (edu)

**English** — `img/c/pk-en/4.png`
...
```
آپ کسی ایکسچینج کے خلاف ٹریڈ نہیں کر رہے۔ آپ کسی دوسرے شخص سے ٹریڈ کر رہے ہیں۔
...
## pk-5 · Referral programme

**English** — `img/c/pk-en/5.png`
...
```
اپنا لنک شیئر کریں۔ وہ بُک پر ٹریڈ کرتے ہیں۔ آپ اس پر کماتے ہیں۔
...
## pk-6 · Growing AI community

**English** — `img/c/pk-en/6.png`

```
Every GPU in Pakistan that takes an AI job gets paid in aiPKR.
...
```
پاکستان کا ہر GPU جو اے آئی کا کام لیتا ہے، aiPKR میں معاوضہ پاتا ہے۔
...
## pk-7 · Why P2P — no middleman

**English** — `img/c/pk-en/7.png`
...
```
‏P2P کا مطلب ہے آپ اور میکر، براہِ راست۔
...
## pk-8 · Payment-method arbitrage

**English** — `img/c/pk-en/8.png`

```
The same USDT is worth different PKR depending on how the money moves.
...
```
وہی USDT اِس بات پر مختلف PKR کا ہوتا ہے کہ پیسہ کیسے حرکت کرتا ہے۔
...
## eg-1 · aiEGP listed on P2P

**English** — `img/c/eg-en/1.png`

```
aiEGP is now trading on the AIST P2P book.
...
```
‏aiEGP أصبح يُتداول على دفتر AIST P2P.
...
**English** — `img/c/eg-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiEGP — all on one book.
...
```
‏BTC وUSDT على خمس شبكات وKGST وETH وSOL وaiEGP — كلها على دفتر واحد.
...
## eg-3 · Simple spread arbitrage

**English** — `img/c/eg-en/3.png`
...
```
نفس الزوج، نفس الدقيقة، وصانعان لا يتفقان على السعر.
...
## eg-4 · What is P2P (edu)

**English** — `img/c/eg-en/4.png`
...
```
أنت لا تتداول ضد منصة. أنت تتداول مع شخص آخر.
...
## eg-5 · Referral programme

**English** — `img/c/eg-en/5.png`
...
```
شارك رابطك. هم يتداولون على الدفتر. وأنت تربح من ذلك.
...
## eg-6 · Growing AI community

**English** — `img/c/eg-en/6.png`

```
Every GPU in Egypt that takes an AI job gets paid in aiEGP.
...
```
كل كرت شاشة في مصر ينفّذ مهمة ذكاء اصطناعي يتقاضى بـaiEGP.
...
## eg-7 · Why P2P — no middleman

**English** — `img/c/eg-en/7.png`
...
## eg-8 · Payment-method arbitrage

**English** — `img/c/eg-en/8.png`

```
The same USDT is worth different EGP depending on how the money moves.
...
```
نفس الـUSDT يساوي مبالغ مختلفة من EGP حسب طريقة تحرك المال.
...
## iq-1 · aiIQD listed on P2P

**English** — `img/c/iq-en/1.png`

```
aiIQD is now trading on the AIST P2P book.
...
```
‏aiIQD أصبح يُتداول على دفتر AIST P2P.
...
**English** — `img/c/iq-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiIQD — all on one book.
...
```
‏BTC وUSDT على خمس شبكات وKGST وETH وSOL وaiIQD — كلها على دفتر واحد.
...
## iq-3 · Simple spread arbitrage

**English** — `img/c/iq-en/3.png`
...
## iq-4 · What is P2P (edu)

**English** — `img/c/iq-en/4.png`
...
## iq-5 · Referral programme

**English** — `img/c/iq-en/5.png`
...
## iq-6 · Growing AI community

**English** — `img/c/iq-en/6.png`

```
Every GPU in Iraq that takes an AI job gets paid in aiIQD.
...
```
كل كرت شاشة في العراق ينفّذ مهمة ذكاء اصطناعي يتقاضى بـaiIQD.
...
## iq-7 · Why P2P — no middleman

**English** — `img/c/iq-en/7.png`
...
## iq-8 · Payment-method arbitrage

**English** — `img/c/iq-en/8.png`

```
The same USDT is worth different IQD depending on how the money moves.
...
```
نفس الـUSDT يساوي مبالغ مختلفة من IQD حسب طريقة تحرك المال.
...
## ao-1 · aiAOA listed on P2P

**English** — `img/c/ao-en/1.png`

```
aiAOA is now trading on the AIST P2P book.
...
```
aiAOA já é negociado no livro P2P da AIST.
...
**English** — `img/c/ao-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiAOA — all on one book.
...
```
BTC, USDT em cinco redes, KGST, ETH, SOL e aiAOA — tudo num livro só.
...
## ao-3 · Simple spread arbitrage

**English** — `img/c/ao-en/3.png`
...
## ao-4 · What is P2P (edu)

**English** — `img/c/ao-en/4.png`
...
```
Você não negocia contra uma exchange. Negocia contra outra pessoa.
...
## ao-5 · Referral programme

**English** — `img/c/ao-en/5.png`
...
```
Compartilhe seu link. Eles negociam no livro. Você ganha com isso.
...
## ao-6 · Growing AI community

**English** — `img/c/ao-en/6.png`

```
Every GPU in Angola that takes an AI job gets paid in aiAOA.
...
```
Cada GPU em Angola que pega uma tarefa de IA recebe em aiAOA.
...
## ao-7 · Why P2P — no middleman

**English** — `img/c/ao-en/7.png`
...
```
P2P significa você e o maker, direto.
...
## ao-8 · Payment-method arbitrage

**English** — `img/c/ao-en/8.png`

```
The same USDT is worth different AOA depending on how the money moves.
...
```
O mesmo USDT vale valores diferentes em AOA conforme o dinheiro se move.
...
## cu-1 · aiCUP listed on P2P

**English** — `img/c/cu-en/1.png`

```
aiCUP is now trading on the AIST P2P book.
...
```
aiCUP ya se opera en el libro P2P de AIST.
...
**English** — `img/c/cu-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiCUP — all on one book.
...
```
BTC, USDT en cinco redes, KGST, ETH, SOL y aiCUP — todo en un solo libro.
...
## cu-3 · Simple spread arbitrage

**English** — `img/c/cu-en/3.png`
...
## cu-4 · What is P2P (edu)

**English** — `img/c/cu-en/4.png`
...
## cu-5 · Referral programme

**English** — `img/c/cu-en/5.png`
...
## cu-6 · Growing AI community

**English** — `img/c/cu-en/6.png`

```
Every GPU in Cuba that takes an AI job gets paid in aiCUP.
...
```
Cada GPU en Cuba que toma un trabajo de IA cobra en aiCUP.
...
## cu-7 · Why P2P — no middleman

**English** — `img/c/cu-en/7.png`
...
## cu-8 · Payment-method arbitrage

**English** — `img/c/cu-en/8.png`

```
The same USDT is worth different CUP depending on how the money moves.
...
```
El mismo USDT vale distintos CUP según cómo se mueva el dinero.
...
## ly-1 · aiLYD listed on P2P

**English** — `img/c/ly-en/1.png`

```
aiLYD is now trading on the AIST P2P book.
...
```
‏aiLYD أصبح يُتداول على دفتر AIST P2P.
...
**English** — `img/c/ly-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiLYD — all on one book.
...
```
‏BTC وUSDT على خمس شبكات وKGST وETH وSOL وaiLYD — كلها على دفتر واحد.
...
## ly-3 · Simple spread arbitrage

**English** — `img/c/ly-en/3.png`
...
## ly-4 · What is P2P (edu)

**English** — `img/c/ly-en/4.png`
...
## ly-5 · Referral programme

**English** — `img/c/ly-en/5.png`
...
## ly-6 · Growing AI community

**English** — `img/c/ly-en/6.png`

```
Every GPU in Libya that takes an AI job gets paid in aiLYD.
...
```
كل كرت شاشة في ليبيا ينفّذ مهمة ذكاء اصطناعي يتقاضى بـaiLYD.
...
## ly-7 · Why P2P — no middleman

**English** — `img/c/ly-en/7.png`
...
## ly-8 · Payment-method arbitrage

**English** — `img/c/ly-en/8.png`

```
The same USDT is worth different LYD depending on how the money moves.
...
```
نفس الـUSDT يساوي مبالغ مختلفة من LYD حسب طريقة تحرك المال.
...
## sd-1 · aiSDG listed on P2P

**English** — `img/c/sd-en/1.png`

```
aiSDG is now trading on the AIST P2P book.
...
```
‏aiSDG أصبح يُتداول على دفتر AIST P2P.
...
**English** — `img/c/sd-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiSDG — all on one book.
...
```
‏BTC وUSDT على خمس شبكات وKGST وETH وSOL وaiSDG — كلها على دفتر واحد.
...
## sd-3 · Simple spread arbitrage

**English** — `img/c/sd-en/3.png`
...
## sd-4 · What is P2P (edu)

**English** — `img/c/sd-en/4.png`
...
## sd-5 · Referral programme

**English** — `img/c/sd-en/5.png`
...
## sd-6 · Growing AI community

**English** — `img/c/sd-en/6.png`

```
Every GPU in Sudan that takes an AI job gets paid in aiSDG.
...
```
كل كرت شاشة في السودان ينفّذ مهمة ذكاء اصطناعي يتقاضى بـaiSDG.
...
## sd-7 · Why P2P — no middleman

**English** — `img/c/sd-en/7.png`
...
## sd-8 · Payment-method arbitrage

**English** — `img/c/sd-en/8.png`

```
The same USDT is worth different SDG depending on how the money moves.
...
```
نفس الـUSDT يساوي مبالغ مختلفة من SDG حسب طريقة تحرك المال.
...
## ir-1 · aiIRR listed on P2P

**English** — `img/c/ir-en/1.png`

```
aiIRR is now trading on the AIST P2P book.
...
```
‏aiIRR حالا روی دفتر AIST P2P معامله می‌شود.
...
**English** — `img/c/ir-en/2.png`

```
BTC, USDT on five networks, KGST, ETH, SOL and aiIRR — all on one book.
...
```
‏BTC، USDT روی پنج شبکه، KGST، ETH، SOL و aiIRR — همه روی یک دفتر.
...
## ir-3 · Simple spread arbitrage

**English** — `img/c/ir-en/3.png`
...
```
همان جفت، همان دقیقه، و دو میکر که سر قیمت توافق ندارند.
...
## ir-4 · What is P2P (edu)

**English** — `img/c/ir-en/4.png`
...
```
شما در برابر یک صرافی معامله نمی‌کنید. با یک آدم دیگر معامله می‌کنید.
...
## ir-5 · Referral programme

**English** — `img/c/ir-en/5.png`
...
```
لینکتان را بدهید. آن‌ها روی دفتر معامله می‌کنند. شما از آن سود می‌برید.
...
## ir-6 · Growing AI community

**English** — `img/c/ir-en/6.png`

```
Every GPU in Iran that takes an AI job gets paid in aiIRR.
...
```
هر کارت گرافیکی در ایران که کار هوش مصنوعی می‌گیرد، با aiIRR پول می‌گیرد.
...
## ir-7 · Why P2P — no middleman

**English** — `img/c/ir-en/7.png`
...
## ir-8 · Payment-method arbitrage

**English** — `img/c/ir-en/8.png`

```
The same USDT is worth different IRR depending on how the money moves.
...
```
همان USDT بسته به نحوه حرکت پول، IRR متفاوتی می‌ارزد.
